...
class MainApp(Gtk.Window):
	...
	def save_data(self, *args):
		...
		# write to a temp file first, then swap it in, so an
		# interrupted save can never leave an empty/corrupt file
	...
	def load_data(self):
		try:
			...
			# missing or corrupted save file -> start fresh
			data = []
